...
public class GameJFrame extends JFrame implements KeyListener, MouseListener {
    ...
    private void initImage() {
        ...
        //显示游戏胜利图片
        ImageIcon winner = new ImageIcon("puzzlegame\\image\\win.png");
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if (source == rePlayItem) {
            ...
            //创建图片对象
            ImageIcon account = new ImageIcon("puzzlegame\\image\\about.png");
            ...
            path = "puzzlegame\\image\\girl\\girl" + (random.nextInt(13) + 1) + "\\";
            //步数清零
            step = 0;
            initData();
            initImage();
        } else if (source == animalItem) {
            path = "puzzlegame\\image\\animal\\animal" + (random.nextInt(8) + 1) + "\\";
            //步数清零
            step = 0;
            initData();
            initImage();
        } else if (source == sportItem) {
            path = "puzzlegame\\image\\sport\\sport" + (random.nextInt(10) + 1) + "\\";
            //步数清零
            step = 0;
            initData();
            initImage();
