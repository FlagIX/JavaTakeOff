...
public class LoginJFrame extends MyJFrame {
    ...
    public LoginJFrame() {
        //设置图标
        setIconImage(Toolkit.getDefaultToolkit().getImage("JavaTakeOff\\myfunction\\image\\logo.jpg"));
    ...
    public void initView() {
        JLabel image = new JLabel(new ImageIcon("JavaTakeOff\\myfunction\\image\\kit.jpg"));
