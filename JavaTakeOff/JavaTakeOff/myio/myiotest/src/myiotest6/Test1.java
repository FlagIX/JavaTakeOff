...
public class Test1 {
    public static void main(String[] args) throws IOException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("JavaTakeOff\\myio\\myiotest\\src\\myiotest6\\names.txt"));
        String line;
        ...
        stu.setWeight(w);
        //7.把集合中的数据再次写到文件中
        BufferedWriter bw = new BufferedWriter(new FileWriter("JavaTakeOff\\myio\\myiotest\\src\\myiotest6\\names.txt"));
        for (Student student : list) {
